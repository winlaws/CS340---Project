  ...
  <body>
    <?php
      ...
      if(!$stmt->fetch()){
        ...
        // <form method="post" action="AddNewReview.php" class="col-lg-6 col-lg-offset-3">
        echo '<div class="col-lg-8 col-lg-offset-2">
                <h1 class="text-center"> Write New Review For ' . $name . '</h1>
                <br/>
                <form method="post" action="RestaurantPage.php?rid=' . $_GET['rid'] . '" class="col-lg-6 col-lg-offset-3">
